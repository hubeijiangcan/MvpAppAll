package com.mitbbs.mvpappall.widget;
...
import com.mitbbs.mvpappall.utils.MeasureUtils;
...
public class SimpleButton extends View{
    // 3种外形模式：圆角矩形、圆弧、直角矩形
    public final static int SHAPE_ROUND_RECT = 0x01;
    public final static int SHAPE_ARC = 0x02;
    public final static int SHAPE_RECT = 0x03;

    // 类型模式：正常、可选中、图标选中消失、图标选中切换
    public final static int MODE_NORMAL = 0x11;
    public final static int MODE_CHECK = 0x12;
    public final static int MODE_ICON_CHECK_INVISIBLE = 0x13;
    public final static int MODE_ICON_CHECK_CHANGE = 0x14;
